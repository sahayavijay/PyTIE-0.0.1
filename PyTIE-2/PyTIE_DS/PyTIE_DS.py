class topological_indices_DegreeSum:
    def topoexpressds():
        try:
            print("Provide your data to calculate Neighborhood Degree-sum based Topological Descriptors:")
            import numpy
            import math
            import sympy as sp
            x=sp.Symbol("x")
            ...
            h=int(input("Specify the quantity of edge partitions in the given system: "))
            ...
            def second_Zagreb():       
                ...
                for i in l2:
                    sum2=sum2+i
                print("Neighborhood Second Zagreb index =",(sum2))
                for i in range(1,n_n_v+1):
                    n_v=sum2.subs(x,i) #n_v-numerical values
                    l_n_v2.append(n_v) #l_n_v2-2nd list of numerical values
                print('N.V of Neighborhood Second Zagreb index = ', l_n_v2)
            second_Zagreb()
            ...
            def hy_Zagreb(): 
                ...
                for i in l3:
                    sum3=sum3+i
                print("Neighborhood Hyper Zagreb index =",(sum3))
                for i in range(1,n_n_v+1):
                    n_v=sum3.subs(x,i) #n_v-numerical values
                    l_n_v3.append(n_v) #l_n_v3-3rd list of numerical values
                print('N.V of Neighborhood Hyper Zagreb index = ', l_n_v3)
            hy_Zagreb() 
            #Third Zagreb index
            def third_Zagreb():     
                sum4=0
                ...
                for i in l4:
                    sum4=sum4+i
                print("Neighborhood Third Zagreb index =",(sum4))
                for i in range(1,n_n_v+1):
                    n_v=sum4.subs(x,i) #n_v-numerical values
                    l_n_v4.append(n_v) 
                print('N.V of Neighborhood Third Zagreb index = ', l_n_v4)
            third_Zagreb()
            #Reduced Zagreb index
            def redu_Zagreb():     
                sum5=0
                ...
                for i in l5:
                    sum5=sum5+i
                print("Neighborhood Reduced Zagreb index =",(sum5))
                for i in range(1,n_n_v+1):
                    n_v=sum5.subs(x,i) #n_v-numerical values
                    l_n_v5.append(n_v) 
                print('N.V of Neighborhood Reduced Zagreb index = ', l_n_v5)
            redu_Zagreb()
            #Second modified zagreb index
            def second_modi_Zagreb():
                ...
                for i in l6:
                    sum6=sum6+i
                print("Neighborhood Second modified Zagreb index =",(sum6))
                for i in range(1,n_n_v+1):
                    n_v=sum6.subs(x,i) #n_v-numerical values
                    l_n_v6.append(n_v) 
                print('N.V of Neighborhood Second modified Zagreb index = ', l_n_v6)
            second_modi_Zagreb()
            #Randic index
            def Randic():
                sum7=0
                ...
                for i in l7:
                    sum7=sum7+i
                print("Neighborhood Randic index",(sum7))
                for i in range(1,n_n_v+1):
                    n_v=sum7.subs(x,i) #n_v-numerical values
                    l_n_v7.append(n_v) 
                print('N.V of Neighborhood Randic index = ', l_n_v7)
            Randic()
            #Reciprocal Randic index
            def reci_Randic():    
                sum8=0
                ...
                for i in l8:
                    sum8=sum8+i
                print("Neighborhood Reciprocal Randic index =",(sum8))
                for i in range(1,n_n_v+1):
                    n_v=sum8.subs(x,i) #n_v-numerical values
                    l_n_v8.append(n_v) 
                print('N.V of Neighborhood Reciprocal Randic index = ', l_n_v8)
            reci_Randic()
            #Reduced reciprocal Randic index
            def redu_reci_Randic():        
                ...
                for i in l9:
                    sum9=sum9+i
                print("Neighborhood Reduced reciprocal Randic index =",(sum9))
                for i in range(1,n_n_v+1):
                    n_v=sum9.subs(x,i) #n_v-numerical values
                    l_n_v9.append(n_v) 
                print('N.V of Neighborhood Reduced reciprocal Randic index = ', l_n_v9)
            redu_reci_Randic()
            #General Randic index
            def gen_Randic():
                sum10=0
                ...
                for i in l10:
                    sum10=sum10+i
                print("Neighborhood General Randic index =",(sum10))
                for i in range(1,n_n_v+1):
                    n_v=sum10.subs(x,i) #n_v-numerical values
                    l_n_v10.append(n_v) 
                print('N.V of Neighborhood General Randic index = ', l_n_v10)
            gen_Randic()
            #Atom bond connectivity index
            def atm_bnd_connect():
                sum11=0
                ...
                for i in l11:
                    sum11=sum11+i
                print("Neighborhood Atom bond connectivity index =",(sum11))
                for i in range(1,n_n_v+1):
                    n_v=sum11.subs(x,i) #n_v-numerical values
                    l_n_v11.append(n_v) 
                print('N.V of Neighborhood Atom bond connectivity index = ', l_n_v11)
            atm_bnd_connect()
            #Geometric Arithematic index
            def geom_arith():
                sum12=0
                ...
                for i in l12:
                    sum12=sum12+i
                print("Neighborhood Geometric Arithematic index =",(sum12))
                for i in range(1,n_n_v+1):
                    n_v=sum12.subs(x,i) #n_v-numerical values
                    l_n_v12.append(n_v) 
                print('N.V of Neighborhood Geometric Arithematic index = ', l_n_v12)
            geom_arith()
            #Harmonic index
            def harm():            
                sum13=0
                ...
                for i in l13:
                    sum13=sum13+i
                print("Neighborhood Harmonic index =",(sum13))
                for i in range(1,n_n_v+1):
                    n_v=sum13.subs(x,i) #n_v-numerical values
                    l_n_v13.append(n_v) 
                print('N.V of Neighborhood Harmonic index = ', l_n_v13)
            harm()
            #Sum-connectivity index
            def sum_connect():
                sum14=0
                ...
                for i in l14:
                    sum14=sum14+i
                print("Neighborhood Sum-connectivity index =",(sum14))
                for i in range(1,n_n_v+1):
                    n_v=sum14.subs(x,i) #n_v-numerical values
                    l_n_v14.append(n_v) 
                print('N.V of Neighborhood Sum-connectivity index = ', l_n_v14)
            sum_connect()
            #Inverse sum index
            def inv_sum():
                sum15=0
                ...
                for i in l15:
                    sum15=sum15+i
                print("Neighborhood Inverse sum index =",(sum15))
                for i in range(1,n_n_v+1):
                    n_v=sum15.subs(x,i) #n_v-numerical values
                    l_n_v15.append(n_v) 
                print('N.V of Neighborhood Inverse sum index = ', l_n_v15)
            inv_sum()
            #Alberston index
            def alberst():
                sum16=0
                ...
                for i in l16:
                    sum16=sum16+i
                print("Neighborhood Alberston index =",(sum16))
                for i in range(1,n_n_v+1):
                    n_v=sum16.subs(x,i) #n_v-numerical values
                    l_n_v16.append(n_v) 
                print('N.V of Neighborhood Alberston index = ', l_n_v16)
            alberst()
            #Symmetric division index
            def symm_div():       
                sum17=0
                ...
                for i in l17:
                    sum17=sum17+i
                print("Neighborhood Symmetric division index =",(sum17))
                for i in range(1,n_n_v+1):
                    n_v=sum17.subs(x,i) #n_v-numerical values
                    l_n_v17.append(n_v) 
                print('N.V of Neighborhood Symmetric division index = ', l_n_v17)
            symm_div()
            #Forgotten index
            def forgot():
                sum18=0
                ...
                for i in l18:
                    sum18=sum18+i
                print("Neighborhood Forgotten index =",(sum18))
                for i in range(1,n_n_v+1):
                    n_v=sum18.subs(x,i) #n_v-numerical values
                    l_n_v18.append(n_v) 
                print('N.V of Neighborhood Forgotten index = ', l_n_v18)
            forgot() 
            #Sombor index
            def somb():
                sum19=0
                ...
                for i in l19:
                    sum19=sum19+i
                print("Neighborhood Sombor index =",(sum19))
                for i in range(1,n_n_v+1):
                    n_v=sum19.subs(x,i) #n_v-numerical values
                    l_n_v19.append(n_v) 
                print('N.V of Neighborhood Sombor index = ', l_n_v19)
            somb()
            #bi-Zagreb index
            def biZagreb():
                sum20=0
                ...
                for i in l20:
                    sum20=sum20+i
                print("Neighborhood bi-Zagreb index =",(sum20))
                for i in range(1,n_n_v+1):
                    n_v=sum20.subs(x,i) #n_v-numerical values
                    l_n_v20.append(n_v) 
                print('N.V of Neighborhood bi-Zagreb index = ', l_n_v20)
            biZagreb()
            #Tri-Zagreb index
            def TriZagreb():
                sum21=0
                ...
                for i in l21:
                    sum21=sum21+i
                print("Neighborhood Tri-Zagreb index =",(sum21))
                for i in range(1,n_n_v+1):
                    n_v=sum21.subs(x,i) #n_v-numerical values
                    l_n_v21.append(n_v) 
                print('N.V of Neighborhood Tri-Zagreb index = ', l_n_v21)
            TriZagreb()
            #Geometric Harmonic index
            def GeomHarm():
                sum22=0
                ...
                for i in l22:
                    sum22=sum22+i
                print("Neighborhood Geometric Harmonic index =",(sum22))
                for i in range(1,n_n_v+1):
                    n_v=sum22.subs(x,i) #n_v-numerical values
                    l_n_v22.append(n_v) 
                print('N.V of Neighborhood Geometric Harmonic index = ', l_n_v22)
            GeomHarm()
            #Geometric Bi-Zagreb index
            def GeomBiZagreb():
                sum23=0
                ...
                for i in l23:
                    sum23=sum23+i
                print("Neighborhood Geometric Bi-Zagreb index =",(sum23))
                for i in range(1,n_n_v+1):
                    n_v=sum23.subs(x,i) #n_v-numerical values
                    l_n_v23.append(n_v) 
                print('N.V of Neighborhood Geometric Bi-Zagreb index = ', l_n_v23)
            GeomBiZagreb()
            #Geometric Tri-Zagreb index
            def GeomTriZagreb():
                sum24=0
                ...
                for i in l24:
                    sum24=sum24+i
                print("Neighborhood Geometric Tri-Zagreb index =",(sum24))
                for i in range(1,n_n_v+1):
                    n_v=sum24.subs(x,i) #n_v-numerical values
                    l_n_v24.append(n_v) 
                print('N.V of Neighborhood Geometric Tri-Zagreb index = ', l_n_v24)
            GeomTriZagreb()
            #Harmonic-Geometric index
            def HarmGeom():
                sum25=0
                ...
                for i in l25:
                    sum25=sum25+i
                print("Neighborhood Harmonic-Geometric index =",(sum25))
                for i in range(1,n_n_v+1):
                    n_v=sum25.subs(x,i) #n_v-numerical values
                    l_n_v25.append(n_v) 
                print('N.V of Neighborhood Harmonic-Geometric index = ', l_n_v25)
            HarmGeom()
        except Exception:
